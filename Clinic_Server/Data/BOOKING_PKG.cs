...
namespace Clinic_Server.Data
{
    public class BOOKING_PKG : AddDbContext
    {
        ...
        public Booking UpdateBooking(int bookId, int userId, Booking booking)
        {
            Booking book = new Booking();
            try
            {
                ...
                this.conn.Open();
                this.cmd.Connection = this.conn;
                this.cmd.CommandText = "PKG_BOOKING.update_book";
                this.cmd.CommandType = CommandType.StoredProcedure;
                this.cmd.Parameters.Add("p_date", OracleDbType.Varchar2).Value = booking.date;
                this.cmd.Parameters.Add("p_time", OracleDbType.Varchar2).Value = booking.time;
                this.cmd.Parameters.Add("p_user_id", OracleDbType.Int32).Value = userId;
                this.cmd.Parameters.Add("p_book_id", OracleDbType.Int32).Value = bookId;
        ...
        public int GetUserBooks(int userId)
        {
            int totalCount = 0;
            var books = new List<Booking>();
            try
            {
                ...
                this.conn.Open();
                this.cmd.Connection = this.conn;
                this.cmd.CommandText = "PKG_BOOKING.get_book_count";
                this.cmd.CommandType = CommandType.StoredProcedure;
